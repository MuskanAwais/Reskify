...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  // Trades endpoint with comprehensive activities
  ...
  // Generate SWMS with comprehensive risk assessments
  ...
  // Generate detailed risk assessments for activities
  app.post("/api/generate-risk-assessments", async (req, res) => {
    try {
      const { activities, tradeType } = req.body;
      
      // Import the AI risk assessment generator
