...
- June 18, 2025. Complete PDF Layout Fixes & 2x2 Matrix Implementation - Fixed construction control risk matrix from 4x1 to proper 2x2 grid layout with A, B cards on top row and C, D cards on bottom row. Resolved black background text visibility issues ensuring proper contrast throughout document. Added complete Plant & Equipment Register section with equipment details, risk levels, and inspection dates. Enhanced SWMS table to show 4 activities properly within card boundaries. Eliminated blank pages through optimized card positioning. System generates 205KB single-page documents in 204ms with all sections visible and properly formatted.
