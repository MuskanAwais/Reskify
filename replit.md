...
- June 30, 2025. User-Specific Analytics & Interface Streamlining - Completely redesigned analytics to show user-specific data matching My SWMS (3 documents for user 999 instead of system-wide 7). Removed compliance score card, documents by trade chart, and compliance trend chart as requested since companies typically focus on single trades. Analytics now displays Total Documents, Active Documents, Draft Documents, and Risk Level Distribution only. Updated page title to "My Document Analytics" reflecting personal focus. Analytics data now perfectly matches My SWMS section showing consistent user document counts. Simplified interface provides relevant metrics without misleading compliance percentages or performance indicators.
