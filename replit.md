...
- June 26, 2025. Safety Library Folder Organization & Document Viewer Implementation - Completed comprehensive Safety Library improvements with folder-based document organization system. Documents now automatically categorized into collapsible folders: Code of Practices (expanded by default), Standards, Guidelines, and Other Documents. Implemented document viewer popup with detailed information display including category, authority, tags, and preview functionality. Added folder expansion/collapse with visual indicators (folder icons, document counts, chevron arrows). Enhanced document cards with View and Download buttons for each document. Removed 29 duplicate documents from database for clean organization. Safety Library now displays 17 unique documents in organized folder structure with comprehensive viewing capabilities.
