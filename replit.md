...
- June 18, 2025. Complete PDF Enhancement with Legislation & Improved Formatting - Added Australian legislation references to all SWMS activities (WHS Regulation 2017, AS/NZS standards). Reformatted activities table to display hazards and control measures on separate lines instead of comma-separated text for better readability. Optimized 2x2 construction risk matrix spacing to fit properly within main card with appropriate gaps between A, B, C, D sections. Enhanced activities table with 8 comprehensive electrical activities including detailed legislation compliance. System generates 210KB multi-page documents in 159ms with professional formatting and Australian WHS compliance.
